...
<script type="text/javascript">
	$(function() {
		...
		$.ajax({
			type : "get",
				url : 'front/rollImageFirst',
				success : function(data) {
					var html = '<dl class=""></dl>';
					var objs = jQuery.parseJSON(data);
					for (var i = 0; i < objs.length; i++) {
						html += '<dl class=""><dt><a href="http://www.zztuku.com" title="" target="_blank"><img src='+objs[i].imgUrl+' alt="2011城市主题公园亲子游"></a></dt>';
						html += '<dd><h2><a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a></h2></dd></dl>';
					}
...
$(function() {
	...
	$.ajax({
				...
				url : 'http://localhost:8080/b2c-background/productCategory/allCategory/0'
			})
})
function Handle(node) {
		var html = '';
		for (var i = 0; i < node.length; i++) {
			html += '<li id="cat_1" class="">';
			html += '<h3><a href="" title="'+node[i].name+'">' + node[i].name
					+ '</a></h3>';
			if (true) {
				html += '<div id="cat_1_menu" class="cat_menu clearfix" style="">';
				for (var j = 0; j < node[i].child.length; j++) {
					html += '<dl class="clearfix">';
					html += '<dt><a href="'+node[i].child[j].name+'" href="">'
							+ node[i].child[j].name + '</a></dt>';
					html += '<dd>';
						if (node[i].child[j].child.length!=0) {
							for (var k = 0; k < node[i].child[j].child.length; k++) {
								html += '<a href="">' + node[i].child[j].child[k].name
										+ '</a>';
							}
						} 
					html += '</dd>';
		...
		var dom = document
				.getElementsByClassName("shop_hd_menu_all_category_hd_menu")[0];
		dom.innerHTML = html;
		...
		<div class="shop_hd_header">
			...
			<div class="shop_hd_header_search">
				...
				<div class="search_form">
					<form method="post" action="http://localhost:8082/b2c-search/search/queryByMain/1">
						<div class="search_formstyle">
							<input type="text" class="search_form_text" name="mainSearch"
								 /> <input type="submit"
		...
		<div class="shop_bd_top clearfix">
			...
			<div class="shop_bd_top_center">
					...
					<div id="xifan_bd1lfimg">
						<div id="rollImage">
							...
							<dl class="">
								...
								<dd>
									<h2>
										<a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a>
									</h2>
								</dd>
							</dl>
							<dl class="">
								<dt>
									<a href="http://www.zztuku.com" title="" target="_blank"><img
										src="images/e50b5d398e3b890f08e14defbc71a94d.jpg"
										alt="潜入城市周边清幽之地"></a>
								</dt>
								<dd>
									<h2>
							...
							<dl class="">
								<dt>
									<a href="http://www.zztuku.com" title="" target="_blank"><img
										src="images/196b173f15685a2019ab3396cd1851a4.jpg"
										alt="盘点中国最美雪山"></a>
								</dt>
								<dd>
									<h2>
										<a href="http://www.zztuku.com" target="_blank">盘点中国最美雪山</a>
									</h2>
								</dd>
							</dl>
							<dl class="">
								<dt>
									<a href="http://www.zztuku.com" title="" target="_blank"><img
										src="images/e81345cbc3d8a7e11f9a0e09df68221d.jpg"
										alt="2011西安世园会攻略"></a>
								</dt>
								<dd>
									<h2>
										<a href="http://www.zztuku.com" target="_blank">2011西安世园会攻略</a>
									</h2>
								</dd>
							</dl>
							<dl class="">
								<dt>
									<a href="http://www.zztuku.com" title="" target="_blank"><img
										src="images/65662b58848da87812ba371c7ff6c1ad.jpg"
										alt="五月乐享懒人天堂塞班岛"></a>
								</dt>
								<dd>
									<h2>
										<a href="http://www.zztuku.com" target="_blank">五月乐享懒人天堂塞班岛</a>
									</h2>
								</dd>
							</dl>
				...
				<div class="shop_bd_top_center_hot">
					<img src="images/index.guanggao.png" />
				</div>
			</div>
			...
			<div class="shop_bd_top_right clearfix">
				<div class="shop_bd_top_right_quickLink">
					<a href="" class="login" title="会员登录"><i></i>会员登录</a> <a href=""
						...
						<ul>
							<li>
								<dl>
									<dt>
										<a href=""><img
											src="images/365_7d5e08127b8d6799209674ecffbfc624.jpg_small.jpg" /></a>
									</dt>
									<dd>
										<a href="">11111111棉布艺双人沙发垫沙发巾飘窗垫素雅黄花</a>
									</dd>
									<dd>
										商城价：<em>256.00</em>元
									</dd>
							...
							<li>
								<dl>
									...
									<dd>
										<a href="">外贸田园绗缝全棉布艺双人沙发垫沙发巾飘窗垫素雅黄花</a>
									</dd>
									<dd>
										商城价：<em>256.00</em>元
									</dd>
						...
						<ul>
							<li>
								<dl>
									...
									<dd>
										<a href="">2222222棉布艺双人沙发垫沙发巾飘窗垫素雅黄花</a>
									</dd>
									<dd>
										商城价：<em>256.00</em>元
									</dd>
						...
						<ul>
							<li>
								<dl>
									...
									<dd>
										<a href="">3333333全棉布艺双人沙发垫沙发巾飘窗垫素雅黄花</a>
									</dd>
									<dd>
										商城价：<em>256.00</em>元
									</dd>
		...
		<div class="shop_bd_home_block clearfix">
			...
			<div class="shop_bd_home_block_left">
				...
				<div class="shop_hd_home_block_left_class clearfix">
					<dl class="clearfix">
						<dt>女装</dt>
						<dd>
							<a href="">棉衣</a> <a href="">毛呢大衣</a> <a href="">风衣</a> <a
								href="">打底衫</a> <a href="">情侣装</a> <a href="">毛呢短裤</a> <a
								href="">牛仔裤</a> <a href="">加绒打...</a> <a href="">小脚裤</a> <a
								href="">半身裙</a>
						</dd>
					</dl>
					...
					<dl class="clearfix">
						<dt>男装</dt>
						<dd>
							<a href="">羽绒服</a> <a href="">卫衣</a> <a href="">长袖T桖</a> <a
								href="">长袖衬衫</a> <a href="">风衣</a> <a href="">休闲西装</a> <a
								href="">棉衣</a> <a href="">休闲长裤</a> <a href="">内衣内裤</a>
						</dd>
					</dl>
				...
				<div class="shop_bd_home_block_left_pic">
					<a href=""><img
						src="images/web-1-13_53bfbfc958cb55a435545033bd075bf3.png" /></a>
				</div>
			</div>
			<!-- 左边 End -->
					...
					<ul>
						<li>
							<dl>
								<dt>
									<a href=""><img
										src="images/04fb225ea46bd1346f330400eedb7ef2.jpg_small.jpg" /></a>
								</dt>
								<dd>
									<a href="">正品都市时尚女装假两件优雅针织衫</a>
								</dd>
								<dd>
									商城价：<em>182.00</em>元
								</dd>
			...
			<div class="shop_bd_home_block_right">
				...
				<ol class="saletop-list">
					...
					<li class="normal"><i>4</i> <a href="">2011秋冬新款韩版大码毛领毛呢外套呢子大衣【演示数据】</a>
					</li>
					<li class="normal"><i>5</i> <a href="">2011秋冬新款韩版大码毛领毛呢外套呢子大衣【演示数据】</a>
					</li>
					<li class="normal"><i>6</i> <a href="">2011秋冬新款韩版大码毛领毛呢外套呢子大衣【演示数据】</a>
					</li>
					<li class="normal"><i>7</i> <a href="">2011秋冬新款韩版大码毛领毛呢外套呢子大衣【演示数据】</a>
					</li>

				</ol>
				<div class="saletop-list_adv_pic">
					<a href=""><img
						src="images/web-3-38_ff9bd2d724f7138cec1b1937000f4feb.jpg" /></a>
				</div>
			</div>
			<!-- 右边商品排行 -->
			...
			<div class="shop_bd_home_block_bottom">
				<ul class="">
					<li><a href=""><img
							src="images/354b80528d2fbeefbab33c563532517e.gif" /></a></li>
					<li><a href=""><img
							src="images/1d2dfbead590510046a6522551db8139.gif" /></a></li>
					<li><a href=""><img
							src="images/26247430b09daa1b441b46008bfb6e6e.gif" /></a></li>
					<li><a href=""><img
							src="images/a0ac8c6d2d3dc1470d5876923182a8e2.gif" /></a></li>
					<li><a href=""><img
							src="images/9c5dee77a6ecdafd9e152fed8c6a4e90.gif" /></a></li>
					<li><a href=""><img
							src="images/b175883eba95e793affb1b1ebbbf85a5.gif" /></a></li>
					<li><a href=""><img
							src="images/6e61a1c953e5bc8c5f1ffdac36862245.gif" /></a></li>
					<li><a href=""><img
							src="images/209abd835cd2ce2208f2dc42ba10efb4.gif" /></a></li>
				</ul>
			</div>
			<!-- 品牌展示 End -->
