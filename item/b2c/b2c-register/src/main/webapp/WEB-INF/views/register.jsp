...
<script type="text/javascript">
	$(function() {
		...
		$("#getPhoneCode").click(function() {
			$.ajax({
				type:'get',
				url:'http://localhost:8090/b2c-massage/sendCode',
		...
		$("#phoneCode").focusout(function() {
			...
			if(len!=6){
				...
				$.ajax({
					type:'post',
					url:'http://localhost:8085/b2c-register/register/checkCode',
					data:"phoneCode="+code,
...
<body>
	...
	<div class="main">
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="${pageContext.request.contextPath}/register/register"
					...
					<dl>
						<dt>确认密码</dt>
						<dd>
							<input type="password" name="confirm" id="confirm" class="text" />
						</dd>
					</dl>
					<dl>
						<dt>邮箱</dt>
					...
					<dl>
						<dt>中国 0086</dt>
						<dd>
							<input type="text" id="phone" name="phone" placeholder="建议使用常用手机" class="text"/>
						</dd>
					</dl>
					<dl>
						<dt>手机验证码</dt>
						...
						<dd>
							<input type="text" name="phoneCode"
								maxlength="6" id="phoneCode" size="17" style="height: 22px;"
					...
					<dl>
						...
						<dd>
							<input type="submit" value="立即注册" class="submit" /> <input
								type="checkbox" checked="checked" />阅读并同意
