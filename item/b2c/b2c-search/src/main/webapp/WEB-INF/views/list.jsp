    ...
    <script type="text/javascript">
    	$(function() {
    		$(".pagination a").live("click",function(){
				...
				$.ajax({
					url:'search/queryByMainAjax/'+$(this).attr('index'),
					type:'post',
					data:{mainSearch:$(".search_form_text").val()},
			...
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_right">
					<ul class="topNav_quick_menu">
						...
						<li>
							<div class="topNav_menu">
								<a href="http://localhost:8093/b2c-cart/gotoCart" class="topNavHover">购物车<b>0</b>种商品<i></i></a>
								<div class="topNav_menu_bd" style="display:none;">
									<!--
						            <ul>
						              <li><a title="已售出的商品" target="_top" href="#">已售出的商品</a></li>
	...
	<div class="shop_bd clearfix">
		...
		<div class="shop_bd_list_right clearfix">
			...
			<small>当前第${page.currentPage}页，共有${page.totalCount}记录，共${page.totalPage}页</small>
				<ul><li><span><a index="1" href="search/queryByMain/1?mainSearch=${mainSearch}">首页</a></span></li>
					...
					<c:if test="${page.currentPage!=page.totalPage}">
						...
						<li><span><a index="${page.totalPage}" href="search/queryByMain/${page.totalPage}?mainSearch=${mainSearch}">尾页</a></span></li>
