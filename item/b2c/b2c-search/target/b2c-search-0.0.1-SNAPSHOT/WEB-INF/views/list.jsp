		...
		<div class="shop_hd_header">
			...
			<div class="shop_hd_header_search">
			    ...
			    <div class="search_form">
			    	<form method="post" action="search/queryByMain/1">
			    		<div class="search_formstyle">
			    			<input type="text" class="search_form_text" name="mainSearch" value="${mainSearch}" />
		...
		<div class="shop_bd_list_right clearfix">
			...
			<div class="shop_bd_list_content clearfix">
				<ul>
					...
					<li>
						<dl>
							<dt><a href=""><img src="${pro.images}" /></a></dt>
							<dd class="title"><a href="">${pro.name}</a>&nbsp;&nbsp;<span>${pro.salePoint}</span></dd>
			...
			<small>当前第${page.currentPage}页，共有${page.totalCount}记录，共${page.totalPage}页</small>
				<ul><li><span><a href="search/queryByMain/1?mainSearch=${mainSearch}">首页</a></span></li>
					<c:if test="${page.currentPage!=1}">
						<li><span><a href="search/queryByMain/${page.currentPage-1}?mainSearch=${mainSearch}">上一页</a></span></li>
					</c:if>
					<c:forEach items="${page.navigatepageNums}" var="num">
						<c:choose>
							<c:when test="${page.currentPage==num}">
								<li><span class="currentpage"><a href="search/queryByMain/${num}?mainSearch=${mainSearch}">${num}</a></span></li>
							</c:when>
							<c:otherwise>
								<li><span><a href="search/queryByMain/${num}?mainSearch=${mainSearch}">${num}</a></span></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					
					<c:if test="${page.currentPage!=page.totalPage}">
					<li><span><a href="search/queryByMain/${page.currentPage+1}?mainSearch=${mainSearch}">下一页</a></span></li>
					</c:if>
					<li><span><a href="search/queryByMain/${page.totalPage}?mainSearch=${mainSearch}">尾页</a></span></li>
